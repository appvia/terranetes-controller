...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *ModuleConstraints) DeepCopyInto(out *ModuleConstraints) {
	*out = *in
	if in.Allowed != nil {
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new ModuleConstraints.
func (in *ModuleConstraints) DeepCopy() *ModuleConstraints {
	if in == nil {
		return nil
	}
	out := new(ModuleConstraints)
